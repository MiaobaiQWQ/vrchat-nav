...
- ![GitHub](/favicons/github.com.png) [VRCFury](https://vrcfury.com/) - 一键配置欧美风格模型，提供大量预设和自动化功能 | [官网](https://vrcfury.com/) | [GitHub](https://github.com/VRCFury/VRCFury) | [加速下载](https://openlist.kipfel.link/vrchat/GitHub/VRCFury)

### 换衣与动画

- ![Booth](/favicons/booth.pm.png) [lilycalInventory](https://lilxyzw.booth.pm/items/5993590) - 换衣换发换材质插件，lilToon作者出品，与着色器完美配合 | [BOOTH](https://lilxyzw.booth.pm/items/5993590) | [加速下载免费版](https://openlist.kipfel.link/vrchat/BOOTH/lilycalInventory)
- ![Gitee](/favicons/gitee.com.ico) [VRC工具箱](https://gitee.com/cmoyuer/vrchat-avatar-toolkit) - 换衣与动画播放工具，国产开源工具箱，支持穿衣绑骨等功能 | [Gitee](https://gitee.com/cmoyuer/vrchat-avatar-toolkit) | [GitHub镜像](https://github.com/achose369/VRChatAvatarToolkit) | [蓝奏云(密码：8b45)](https://moyuer.lanzoub.com/b03qc3hqd)
- ![Gitee](/favicons/gitee.com.ico) [楓苓衣柜MapleCloset](https://gitee.com/MapleRin/MapleCloset/releases) - 换衣与动画管理工具，支持衣柜管理、一键生成功能、MA组件参数计算器、贴图上限调整、可恢复的动骨合并等功能 | [Gitee](https://gitee.com/MapleRin/MapleCloset/releases) | [加速下载](https://openlist.kipfel.link/vrchat/GitHub/MapleCloset) | [视频教程](https://www.bilibili.com/video/BV1nfMvzuE6R/)

### 模型优化工具

- ![GitHub](/favicons/github.com.png) [Avatar Optimizer (AAO)](https://vpm.anatawa12.com/avatar-optimizer/ja/) - 模型自动优化插件，非破坏性减面、合并材质、优化性能 | [官网](https://vpm.anatawa12.com/avatar-optimizer/ja/) | [GitHub](https://github.com/anatawa12/AvatarOptimizer) | [加速下载](https://openlist.kipfel.link/vrchat/GitHub/Avatar%20Optimizer) | [ALCOM](https://vpm.anatawa12.com/add-repo)
- ![GitHub](/favicons/github.com.png) [Avatar Performance Tools](https://github.com/Thryrallo/VRC-Avatar-Performance-Tools) - 贴图尺寸优化工具，计算VRAM使用、检查Blendshapes等 | [GitHub](https://github.com/Thryrallo/VRC-Avatar-Performance-Tools) | [加速下载](https://openlist.kipfel.link/vrchat/GitHub/Avatar%20Performance%20Tools)
- ![GitHub](/favicons/github.com.png) [Mantis LOD Editor + NDMF](https://github.com/bdunderscore/ndmf) - 非破坏性减面插件，NDMF框架提供非破坏性改模支持 | [GitHub](https://github.com/bdunderscore/ndmf) | [加速下载](https://openlist.kipfel.link/vrchat/GitHub/Mantis%20LOD%20Editor+NDMF)
...
- ![VRCQuestTools](/favicons/kurotu.github.io.png) [VRCQuestTools](https://kurotu.github.io/VRCQuestTools) - Unity编辑器扩展，帮助将PC端Avatar转换为Android (Quest, PICO) 兼容版本。可自动处理纹理生成、删除不支持的组件、简化PhysBones等 | [官网](https://kurotu.github.io/VRCQuestTools) | [Booth](https://booth.pm/items/2436054)

### 综合工具集

- ![GitHub](/favicons/github.com.png) [VRCToolkit](https://github.com/VolcanicArts/VRCToolkit) - 一套用于 VRChat 头像和世界开发的工具集合，包含 VRCPackageManager（工具包管理）、UdonBehaviours（易用脚本集合）等 | [GitHub](https://github.com/VolcanicArts/VRCToolkit) | [加速下载](https://openlist.kipfel.link/vrchat/%E6%A8%A1%E5%9E%8B%E6%8F%92%E4%BB%B6/VRCToolkit)
...
- ![Booth](/favicons/booth.pm.png) [ShaderProject](https://booth.pm/ja/items/4497057) - 该名称指向性不强，可能指代社区中各种自定义着色器项目。例如，搜索结果中有用于世界的自定义传送门镜像着色器

## 资源来源

### 模型资源

- ![BOOTH](/favicons/booth.pm.png) [BOOTH](https://booth.pm/) - 日本最大的二次元商品市场，包含大量 VRChat 模型 | [kipfel](https://booth.pm/zh-cn/items/5813187) | [Mamehinata](https://booth.pm/zh-cn/items/4340548)
...
- ![VRLearn](/favicons/VRLearn.png) [VRLearn](https://start.gamemode1.com/) - 改模入门教程(Unity安装以及基础操作) | [VRLearn](https://start.gamemode1.com/) | [哔哩哔哩](https://space.bilibili.com/2796549)
